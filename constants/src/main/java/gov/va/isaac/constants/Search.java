...
public class Search {
	...
	public static ConceptSpec UUID_COLUMN = RefexDynamic.DYNAMIC_SEMEME_DT_UUID;
	...
	public static ConceptSpec ORDER_COLUMN = RefexDynamic.DYNAMIC_SEMEME_COLUMN_ORDER;
